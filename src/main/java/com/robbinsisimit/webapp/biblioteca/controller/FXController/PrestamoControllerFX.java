...
public class PrestamoControllerFX implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        cmbEmpleado.setItems(FXCollections.observableList(empleadoService.listarEmpleado()));
        cmbCliente.setItems(FXCollections.observableList(clienteService.listarCliente()));
        cargarDatos();
    }
